...
from pac_transformers import PreTrainedModel
from pac_transformers.modeling_outputs import QuestionAnsweringModelOutput, SequenceClassifierOutput, TokenClassifierOutput
from pac_transformers.utils import PushToHubMixin

from . import __version__
from .config import PeftConfig

# sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../pac_lora_peft/src')))
from .tuners import (
    AdaLoraModel,
    AdaptionPromptModel,
    BOFTModel,
...
class PeftModelForCausalLM(PeftModel):
    ...
    # peft model for casuallm forward
    def forward(
        self,
        input_ids=None,
        attention_mask=None,
        ...
        **kwargs,
        ...
        if not peft_config.is_prompt_learning:
            ...
            with self._enable_peft_forward_hooks(**kwargs):
                # # filter out special peft forward args 
                # # already remove the two mask.
    ...
    def prepare_inputs_for_generation(self, *args, task_ids: Optional[torch.Tensor] = None, **kwargs):
        ...
        uses_transformers_4_38 = packaging.version.parse(pac_transformers.__version__) >= packaging.version.parse("4.38.0")
        uses_transformers_4_36 = packaging.version.parse(pac_transformers.__version__) >= packaging.version.parse("4.36.0")
